...
class _HomePageState extends State<Compass> {
  int mode = 0, map = 0;
  ...
  Widget Earth() {
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Text(city, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color: Colors.white)),
      Text('lat:${lat.toStringAsFixed(2)}  lon:${lon.toStringAsFixed(2)}',style: TextStyle(color: Colors.white)),
      Expanded(
      ...
      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('${temp.toInt()}°', style: TextStyle(fontSize: 60,color: Colors.white)),
          Text(weather,style: TextStyle(color: Colors.white)),
          Text('Humidity ${humidity.toInt()}%',style: TextStyle(color: Colors.white)),
        ]),
      ]),
    ]);
  }
